...
class CUTModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        parser.add_argument('--lambda_L1', type=float, default=0.1, help='weight for L1 loss: L1(G(X), gt)')
        parser.add_argument('--lambda_SSIM', type=float, default=1.0, help='weight for SSIM loss: SSIM(G(X), gt)')
