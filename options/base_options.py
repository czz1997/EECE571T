...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # dataset parameters
        parser.add_argument('--dataset_mode', type=str, default='paired', help='chooses how datasets are loaded. [paired | single | colorization]')
        ...
        parser.add_argument('--preprocess', type=str, default='resize_and_crop_and_zoom', help='scaling and cropping of images at load time [resize_and_crop | crop | scale_width | scale_width_and_crop | none]')
